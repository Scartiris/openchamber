...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.scheduledTasks.dialog.executionKind.scriptHint": "Ejecuta un comando shell localmente: sin sesión y sin tokens de modelo",
  "sessions.scheduledTasks.dialog.lastOutput.label": "Última salida",
  ...
  "sessions.scheduledTasks.editor.executionKind.label": "Ejecución",
  "sessions.scheduledTasks.editor.executionKind.ai": "Sesión de IA",
  "sessions.scheduledTasks.editor.executionKind.script": "Script local",
  "sessions.scheduledTasks.editor.executionKind.aiHint": "Crea una nueva sesión de IA y envía el prompt al modelo.",
  "sessions.scheduledTasks.editor.executionKind.scriptHint": "Ejecuta un comando shell directamente en esta máquina: sin sesión, cero tokens de modelo.",
  ...
  "sessions.scheduledTasks.editor.validation.commandRequired": "El comando es obligatorio",
  ...
  "chat.toolName.read": "Leer archivo",
  "chat.toolName.write": "Escribir archivo",
  "chat.toolName.edit": "Editar archivo",
  "chat.toolName.multiedit": "Edición múltiple",
  "chat.toolName.applyPatch": "Aplicar parche",
  "chat.toolName.bash": "Comando de shell",
  "chat.toolName.grep": "Buscar en archivos",
  "chat.toolName.glob": "Buscar archivos",
  "chat.toolName.list": "Listar directorio",
  "chat.toolName.task": "Tarea del agente",
  "chat.toolName.webfetch": "Obtener URL",
  "chat.toolName.websearch": "Búsqueda web",
  "chat.toolName.codesearch": "Búsqueda de código",
  "chat.toolName.todowrite": "Actualizar lista de tareas",
  "chat.toolName.todoread": "Leer lista de tareas",
  "chat.toolName.skill": "Cargar habilidad",
  "chat.toolName.question": "Pregunta",
  "chat.toolName.lsp": "LSP",
  "chat.toolName.openchamberWeb": "OpenChamber (Web)",
  "chat.toolName.openchamberMemory": "OpenChamber (Memoria)",
  "chat.toolName.planEnter": "Modo plan",
  "chat.toolName.planExit": "Modo construcción",
  "chat.toolName.structuredOutput": "Salida estructurada",
  "chat.toolName.pigeonMemory": "Memoria de Pigeon",
  "chat.toolName.pigeonProfile": "Perfil de Pigeon",
  "chat.toolName.pigeonConfig": "Configuración de Pigeon",
  "chat.workStatus.section.memoryTools": "Memoria personal",
  "chat.workStatus.memory.written": "{count} escritas",
  "chat.workStatus.memory.readCount": "{count} recuperadas",
  "chat.workStatus.memory.actionWrite": "Escribir",
  "chat.workStatus.memory.actionRead": "Recuperar",
  "chat.workStatus.memory.unnamed": "(sin título)",
  "chat.toolPart.filesCount": "{count} archivos",
  "chat.toolPart.questionsAsked": "{count} pregunta(s) realizada(s)",
  "chat.toolPart.moreHidden": "+{count} más…",
  "chat.toolPart.subagentWaiting": "Esperando actividad del subagente...",
  "chat.toolPart.subagentNoSession": "Sin ID de sesión de subagente en los metadatos de la tarea.",
  "chat.toolPart.todoTasks": "{count} tareas",
  ...
  "tokenUsage.button.aria": "Estadísticas de consumo de tokens",
  "tokenUsage.button.title": "Tokens de hoy — abrir detalles",
  "tokenUsage.dialog.title": "Consumo de tokens",
  "tokenUsage.range.today": "Hoy",
  "tokenUsage.range.7days": "7 días",
  "tokenUsage.range.30days": "30 días",
  "tokenUsage.tab.daily": "Por día",
  "tokenUsage.tab.models": "Por modelo",
  "tokenUsage.tokens.input": "Entrada",
  "tokenUsage.tokens.output": "Salida",
  "tokenUsage.tokens.reasoning": "Razonamiento",
  "tokenUsage.tokens.cacheRead": "Lectura de caché",
  "tokenUsage.tokens.cacheWrite": "Escritura de caché",
  "tokenUsage.tokens.total": "Total",
  "tokenUsage.cost": "Coste de hoy",
