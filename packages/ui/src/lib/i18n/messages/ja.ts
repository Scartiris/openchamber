...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': 'ローカルスクリプト',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': 'シェルコマンドをローカルで実行。セッションなし、モデルトークン消費なし',
  'sessions.scheduledTasks.dialog.lastOutput.label': '最後の出力',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': '実行方法',
  'sessions.scheduledTasks.editor.executionKind.ai': 'AI セッション',
  'sessions.scheduledTasks.editor.executionKind.script': 'ローカルスクリプト',
  'sessions.scheduledTasks.editor.executionKind.aiHint': '新しい AI セッションを作成し、プロンプトをモデルに送信します。',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': 'このマシンでシェルコマンドを直接実行します。セッションなし、トークン消費ゼロ。',
  'sessions.scheduledTasks.editor.command.label': 'コマンド',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': 'コマンドは必須です',
  ...
  'chat.toolName.read': 'ファイルを読み込む',
  'chat.toolName.write': 'ファイルに書き込む',
  'chat.toolName.edit': 'ファイルを編集',
  'chat.toolName.multiedit': '複数編集',
  'chat.toolName.applyPatch': 'パッチを適用',
  'chat.toolName.bash': 'シェルコマンド',
  'chat.toolName.grep': 'ファイル内を検索',
  'chat.toolName.glob': 'ファイルを検索',
  'chat.toolName.list': 'ディレクトリを一覧表示',
  'chat.toolName.task': 'エージェントタスク',
  'chat.toolName.webfetch': 'URLを取得',
  'chat.toolName.websearch': 'Web検索',
  'chat.toolName.codesearch': 'コード検索',
  'chat.toolName.todowrite': 'ToDoを更新',
  'chat.toolName.todoread': 'ToDoを読み込む',
  'chat.toolName.skill': 'スキルを読み込む',
  'chat.toolName.question': '質問',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber（Web）',
  'chat.toolName.openchamberMemory': 'OpenChamber（メモリ）',
  'chat.toolName.planEnter': 'プランモード',
  'chat.toolName.planExit': 'ビルドモード',
  'chat.toolName.structuredOutput': '構造化出力',
  'chat.toolName.pigeonMemory': 'Pigeon メモリ',
  'chat.toolName.pigeonProfile': 'Pigeon プロフィール',
  'chat.toolName.pigeonConfig': 'Pigeon 設定',
  'chat.workStatus.section.memoryTools': '個人メモリ',
  'chat.workStatus.memory.written': '{count} 件書き込み',
  'chat.workStatus.memory.readCount': '{count} 件呼び出し',
  'chat.workStatus.memory.actionWrite': '書き込み',
  'chat.workStatus.memory.actionRead': '呼び出し',
  'chat.workStatus.memory.unnamed': '（タイトルなし）',
  'chat.toolPart.filesCount': '{count} 個のファイル',
  'chat.toolPart.questionsAsked': '{count} 件の質問',
  'chat.toolPart.moreHidden': '他 {count} 件…',
  'chat.toolPart.subagentWaiting': 'サブエージェントのアクティビティを待機中...',
  'chat.toolPart.subagentNoSession': 'タスクメタデータにサブエージェントのセッションIDがありません。',
  'chat.toolPart.todoTasks': '{count} タスク',
  'chat.todo.total': '合計',
  ...
  'tokenUsage.button.aria': 'トークン消費統計',
  'tokenUsage.button.title': '今日のトークン — 詳細を開く',
  'tokenUsage.dialog.title': 'トークン消費',
  'tokenUsage.range.today': '今日',
  'tokenUsage.range.7days': '7日間',
  'tokenUsage.range.30days': '30日間',
  'tokenUsage.tab.daily': '日別',
  'tokenUsage.tab.models': 'モデル別',
  'tokenUsage.tokens.input': '入力',
  'tokenUsage.tokens.output': '出力',
  'tokenUsage.tokens.reasoning': '推論',
  'tokenUsage.tokens.cacheRead': 'キャッシュ読み込み',
  'tokenUsage.tokens.cacheWrite': 'キャッシュ書き込み',
  "tokenUsage.tokens.total": "合計",
  'tokenUsage.cost': '今日のコスト',
