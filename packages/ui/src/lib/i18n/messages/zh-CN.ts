...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': '本地脚本',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': '在本机直接运行 shell 命令——无会话、零模型 token',
  'sessions.scheduledTasks.dialog.lastOutput.label': '最近输出',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': '执行方式',
  'sessions.scheduledTasks.editor.executionKind.ai': 'AI 会话',
  'sessions.scheduledTasks.editor.executionKind.script': '本地脚本',
  'sessions.scheduledTasks.editor.executionKind.aiHint': '创建新的 AI 会话并把提示词发给模型。',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': '直接在本机运行 shell 命令——无会话、零模型 token。',
  'sessions.scheduledTasks.editor.command.label': '命令',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': '命令为必填项',
  ...
  'gitView.history.actions.cherryPick': '拣选',
  ...
  'diffView.reviewDialog.description': '为当前更改启动一个单独的审查会话。',
  ...
  'session.githubIntegration.tabs.pullRequests': '合并请求',
  ...
  'chat.emptyState.draftTitleWithProject': '在 {project} 中做什么？',
  'chat.draftPresets.explore.label': '探索代码库',
  'chat.draftPresets.catchup.label': '帮我回顾',
  ...
  'chat.draftStarters.add': '添加起始项',
  'chat.draftStarters.searchPlaceholder': '搜索命令和技能…',
  'chat.draftStarters.empty': '没有可添加的项目',
  ...
  'chat.queuedMessage.title': '排队的消息',
  ...
  'chat.toolName.read': '读取文件',
  'chat.toolName.write': '写入文件',
  'chat.toolName.edit': '编辑文件',
  'chat.toolName.multiedit': '多处编辑',
  'chat.toolName.applyPatch': '应用补丁',
  'chat.toolName.bash': '终端命令',
  'chat.toolName.grep': '搜索文件',
  'chat.toolName.glob': '查找文件',
  'chat.toolName.list': '列出目录',
  'chat.toolName.task': '智能体任务',
  'chat.toolName.webfetch': '抓取网页',
  'chat.toolName.websearch': '网页搜索',
  'chat.toolName.codesearch': '代码搜索',
  'chat.toolName.todowrite': '更新待办',
  'chat.toolName.todoread': '读取待办',
  'chat.toolName.skill': '加载技能',
  'chat.toolName.question': '提问',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber（网页）',
  'chat.toolName.openchamberMemory': 'OpenChamber（记忆）',
  'chat.toolName.planEnter': '计划模式',
  'chat.toolName.planExit': '构建模式',
  'chat.toolName.structuredOutput': '结构化输出',
  'chat.toolName.pigeonMemory': '记忆存取',
  'chat.toolName.pigeonProfile': '画像管理',
  'chat.toolName.pigeonConfig': '记忆配置',
  'chat.workStatus.section.memoryTools': '个人记忆',
  'chat.workStatus.memory.written': '写入 {count} 条',
  'chat.workStatus.memory.readCount': '召回 {count} 条',
  'chat.workStatus.memory.actionWrite': '写入',
  'chat.workStatus.memory.actionRead': '召回',
  'chat.workStatus.memory.unnamed': '（未命名）',
  'chat.toolPart.filesCount': '{count} 个文件',
  'chat.toolPart.questionsAsked': '已提问 {count} 个问题',
  'chat.toolPart.moreHidden': '+{count} 条…',
  'chat.toolPart.subagentWaiting': '等待子智能体活动...',
  'chat.toolPart.subagentNoSession': '任务元数据中没有子智能体会话 ID。',
  'chat.toolPart.todoTasks': '{count} 个任务',
  'chat.todo.total': '总计',
  ...
  'tokenUsage.button.aria': 'Token 消耗统计',
  'tokenUsage.button.title': '今日 Token — 点击查看详情',
  'tokenUsage.dialog.title': 'Token 消耗',
  'tokenUsage.range.today': '今天',
  'tokenUsage.range.7days': '7 天',
  'tokenUsage.range.30days': '30 天',
  'tokenUsage.tab.daily': '按天',
  'tokenUsage.tab.models': '按模型',
  'tokenUsage.tokens.input': '输入',
  'tokenUsage.tokens.output': '输出',
  'tokenUsage.tokens.reasoning': '推理',
  'tokenUsage.tokens.cacheRead': '缓存读取',
  'tokenUsage.tokens.cacheWrite': '缓存写入',
  "tokenUsage.tokens.total": "合计",
  'tokenUsage.cost': '今日成本',
  'tokenUsage.model': '模型',
  ...
  'contextFileOpen.failure.tooLarge': '文件过大，无法打开（>{count} 行）',
  ...
  'chat.workStatus.rate.label': '输出速率',
  'chat.workStatus.rate.instant': '即时速率',
  'chat.workStatus.rate.avg': '会话平均速率',
