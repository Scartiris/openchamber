...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': '本機腳本',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': '在本機直接執行 shell 命令——無會話、零模型 token',
  'sessions.scheduledTasks.dialog.lastOutput.label': '最近輸出',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': '執行方式',
  'sessions.scheduledTasks.editor.executionKind.ai': 'AI 會話',
  'sessions.scheduledTasks.editor.executionKind.script': '本機腳本',
  'sessions.scheduledTasks.editor.executionKind.aiHint': '建立新的 AI 會話並將提示詞傳送給模型。',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': '直接在本機執行 shell 命令——無會話、零模型 token。',
  ...
  'sessions.scheduledTasks.editor.validation.commandRequired': '命令為必填項',
  ...
  'chat.toolName.read': '讀取檔案',
  'chat.toolName.write': '寫入檔案',
  'chat.toolName.edit': '編輯檔案',
  'chat.toolName.multiedit': '多處編輯',
  'chat.toolName.applyPatch': '套用補丁',
  'chat.toolName.bash': '終端命令',
  'chat.toolName.grep': '搜尋檔案',
  'chat.toolName.glob': '尋找檔案',
  'chat.toolName.list': '列出目錄',
  'chat.toolName.task': '智慧體任務',
  'chat.toolName.webfetch': '擷取網頁',
  'chat.toolName.websearch': '網頁搜尋',
  'chat.toolName.codesearch': '程式碼搜尋',
  'chat.toolName.todowrite': '更新待辦',
  'chat.toolName.todoread': '讀取待辦',
  'chat.toolName.skill': '載入技能',
  'chat.toolName.question': '提問',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber（網頁）',
  'chat.toolName.openchamberMemory': 'OpenChamber（記憶）',
  'chat.toolName.planEnter': '計畫模式',
  'chat.toolName.planExit': '建構模式',
  'chat.toolName.structuredOutput': '結構化輸出',
  'chat.toolName.pigeonMemory': '記憶存取',
  'chat.toolName.pigeonProfile': '畫像管理',
  'chat.toolName.pigeonConfig': '記憶配置',
  'chat.workStatus.section.memoryTools': '個人記憶',
  'chat.workStatus.memory.written': '寫入 {count} 條',
  'chat.workStatus.memory.readCount': '召回 {count} 條',
  'chat.workStatus.memory.actionWrite': '寫入',
  'chat.workStatus.memory.actionRead': '召回',
  'chat.workStatus.memory.unnamed': '（未命名）',
  'chat.toolPart.filesCount': '{count} 個檔案',
  'chat.toolPart.questionsAsked': '已提問 {count} 個問題',
  'chat.toolPart.moreHidden': '+{count} 條…',
  'chat.toolPart.subagentWaiting': '等待子智慧體活動...',
  'chat.toolPart.subagentNoSession': '任務中繼資料中沒有子智慧體會話 ID。',
  'chat.toolPart.todoTasks': '{count} 個任務',
  'chat.todo.total': '總計',
  ...
  'tokenUsage.button.aria': 'Token 消耗統計',
  'tokenUsage.button.title': '今日 Token — 點擊查看詳情',
  ...
  'tokenUsage.tokens.input': '輸入',
  'tokenUsage.tokens.output': '輸出',
  'tokenUsage.tokens.reasoning': '推理',
  'tokenUsage.tokens.cacheRead': '緩存讀取',
  'tokenUsage.tokens.cacheWrite': '緩存寫入',
  "tokenUsage.tokens.total": "合計",
  'tokenUsage.cost': '今日成本',
  'tokenUsage.model': '模型',
  'tokenUsage.empty': '該時間範圍內無 Token 消耗',
  'tokenUsage.error': '載入 Token 統計失敗',
  "tokenUsage.retry": "重試",
  ...
  'chat.workStatus.rate.instant': '即時速率',
  'chat.workStatus.rate.avg': '會話平均速率',
