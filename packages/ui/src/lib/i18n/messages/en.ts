...
export const dict = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': 'Local script',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': 'Runs a local shell command — no session, no model tokens',
  'sessions.scheduledTasks.dialog.lastOutput.label': 'Last output',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': 'Execution',
  'sessions.scheduledTasks.editor.executionKind.ai': 'AI session',
  'sessions.scheduledTasks.editor.executionKind.script': 'Local script',
  'sessions.scheduledTasks.editor.executionKind.aiHint': 'Creates a new AI session and sends the prompt to a model.',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': 'Runs a shell command directly on this machine — no session, zero model tokens.',
  'sessions.scheduledTasks.editor.command.label': 'Command',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': 'Command is required',
  ...
  'chat.toolName.read': 'Read File',
  'chat.toolName.write': 'Write File',
  'chat.toolName.edit': 'Edit File',
  'chat.toolName.multiedit': 'Multi-Edit',
  'chat.toolName.applyPatch': 'Apply Patch',
  'chat.toolName.bash': 'Shell Command',
  'chat.toolName.grep': 'Search Files',
  'chat.toolName.glob': 'Find Files',
  'chat.toolName.list': 'List Directory',
  'chat.toolName.task': 'Agent Task',
  'chat.toolName.webfetch': 'Fetch URL',
  'chat.toolName.websearch': 'Web Search',
  'chat.toolName.codesearch': 'Code Search',
  'chat.toolName.todowrite': 'Update Todo List',
  'chat.toolName.todoread': 'Read Todo List',
  'chat.toolName.skill': 'Load Skill',
  'chat.toolName.question': 'Question',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber (Web)',
  'chat.toolName.openchamberMemory': 'OpenChamber (Memory)',
  'chat.toolName.planEnter': 'Plan Mode',
  'chat.toolName.planExit': 'Build Mode',
  'chat.toolName.structuredOutput': 'Structured Output',
  'chat.toolName.pigeonMemory': 'Pigeon Memory',
  'chat.toolName.pigeonProfile': 'Pigeon Profile',
  'chat.toolName.pigeonConfig': 'Pigeon Config',
  'chat.workStatus.section.memoryTools': 'Personal memory',
  'chat.workStatus.memory.written': '{count} written',
  'chat.workStatus.memory.readCount': '{count} recalled',
  'chat.workStatus.memory.actionWrite': 'Write',
  'chat.workStatus.memory.actionRead': 'Recall',
  'chat.workStatus.memory.unnamed': '(untitled)',
  'chat.toolPart.filesCount': '{count} files',
  'chat.toolPart.questionsAsked': 'Asked {count} question(s)',
  'chat.toolPart.moreHidden': '+{count} more…',
  'chat.toolPart.subagentWaiting': 'Waiting for subagent activity...',
  'chat.toolPart.subagentNoSession': 'No subagent session id on task metadata.',
  'chat.toolPart.todoTasks': '{count} tasks',
  ...
  'tokenUsage.button.aria': 'Token usage statistics',
  'tokenUsage.button.title': 'Tokens today — open details',
  'tokenUsage.dialog.title': 'Token usage',
  'tokenUsage.range.today': 'Today',
  'tokenUsage.range.7days': '7 days',
  'tokenUsage.range.30days': '30 days',
  'tokenUsage.tab.daily': 'By day',
  'tokenUsage.tab.models': 'By model',
  'tokenUsage.tokens.input': 'Input',
  'tokenUsage.tokens.output': 'Output',
  'tokenUsage.tokens.reasoning': 'Reasoning',
  'tokenUsage.tokens.cacheRead': 'Cache read',
  'tokenUsage.tokens.cacheWrite': 'Cache write',
  "tokenUsage.tokens.total": "Total",
  'tokenUsage.cost': 'Cost today',
  ...
  'chat.workStatus.rate.label': 'Output rate',
  'chat.workStatus.rate.instant': 'Instant rate',
  'chat.workStatus.rate.avg': 'Average rate',
