...
export const settingsDict = {
  ...
  'settings.remoteInstances.direct.headers.description': '可选的 HTTP 请求头，适用于桌面端 API 请求。Authorization 保留给连接令牌使用。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.state.viaRelay': '经由中继',
  ...
  'settings.openchamber.visual.field.expandedEditorToolbar': '始终显示编辑器工具栏（固定在文件标签页下方）',
  ...
  'settings.openchamber.visual.field.followUpBehaviorDescription': '选择在智能体仍在响应时，按回车对后续消息的处理方式。',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': '转向',
