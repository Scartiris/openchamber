...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.scheduledTasks.dialog.executionKind.script": "Локальний скрипт",
  "sessions.scheduledTasks.dialog.executionKind.scriptHint": "Виконує команду shell локально — без сесії та без токенів моделі",
  "sessions.scheduledTasks.dialog.lastOutput.label": "Останній вивід",
  ...
  "sessions.scheduledTasks.editor.executionKind.label": "Виконання",
  "sessions.scheduledTasks.editor.executionKind.ai": "Сесія ШІ",
  "sessions.scheduledTasks.editor.executionKind.script": "Локальний скрипт",
  "sessions.scheduledTasks.editor.executionKind.aiHint": "Створює нову сесію ШІ та надсилає промпт моделі.",
  "sessions.scheduledTasks.editor.executionKind.scriptHint": "Виконує команду shell безпосередньо на цій машині — без сесії, нуль токенів моделі.",
  "sessions.scheduledTasks.editor.command.label": "Команда",
  "sessions.scheduledTasks.editor.command.placeholder": "curl -fsS http://127.0.0.1:3001/health",
  "sessions.scheduledTasks.editor.validation.commandRequired": "Команда є обов'язковою",
  ...
  "chat.toolName.read": "Читати файл",
  "chat.toolName.write": "Записати файл",
  "chat.toolName.edit": "Редагувати файл",
  "chat.toolName.multiedit": "Множинне редагування",
  "chat.toolName.applyPatch": "Застосувати патч",
  "chat.toolName.bash": "Команда оболонки",
  "chat.toolName.grep": "Шукати у файлах",
  "chat.toolName.glob": "Знайти файли",
  "chat.toolName.list": "Список каталогу",
  "chat.toolName.task": "Завдання агента",
  "chat.toolName.webfetch": "Отримати URL",
  "chat.toolName.websearch": "Веб-пошук",
  "chat.toolName.codesearch": "Пошук коду",
  "chat.toolName.todowrite": "Оновити список справ",
  "chat.toolName.todoread": "Прочитати список справ",
  "chat.toolName.skill": "Завантажити навичку",
  "chat.toolName.question": "Питання",
  "chat.toolName.lsp": "LSP",
  "chat.toolName.openchamberWeb": "OpenChamber (Веб)",
  "chat.toolName.openchamberMemory": "OpenChamber (Пам'ять)",
  "chat.toolName.planEnter": "Режим плану",
  "chat.toolName.planExit": "Режим збірки",
  "chat.toolName.structuredOutput": "Структурований вивід",
  "chat.toolName.pigeonMemory": "Пам'ять Pigeon",
  "chat.toolName.pigeonProfile": "Профіль Pigeon",
  "chat.toolName.pigeonConfig": "Конфігурація Pigeon",
  "chat.workStatus.section.memoryTools": "Особиста пам'ять",
  "chat.workStatus.memory.written": "{count} записано",
  "chat.workStatus.memory.readCount": "{count} відновлено",
  "chat.workStatus.memory.actionWrite": "Записати",
  "chat.workStatus.memory.actionRead": "Відновити",
  "chat.workStatus.memory.unnamed": "(без назви)",
  "chat.toolPart.filesCount": "{count} файлів",
  "chat.toolPart.questionsAsked": "Задано {count} запитань",
  "chat.toolPart.moreHidden": "+{count} ще…",
  "chat.toolPart.subagentWaiting": "Очікування активності підагента...",
  "chat.toolPart.subagentNoSession": "Немає ID сесії субгента в метаданих завдання.",
  "chat.toolPart.todoTasks": "{count} завдань",
  ...
  "tokenUsage.button.aria": "Статистика витрат токенів",
  "tokenUsage.button.title": "Токени за сьогодні — відкрити деталі",
  "tokenUsage.dialog.title": "Витрата токенів",
  "tokenUsage.range.today": "Сьогодні",
  "tokenUsage.range.7days": "7 днів",
  "tokenUsage.range.30days": "30 днів",
  "tokenUsage.tab.daily": "За день",
  "tokenUsage.tab.models": "За моделлю",
  "tokenUsage.tokens.input": "Введення",
  "tokenUsage.tokens.output": "Виведення",
  "tokenUsage.tokens.reasoning": "Міркування",
  "tokenUsage.tokens.cacheRead": "Зчитування кешу",
  "tokenUsage.tokens.cacheWrite": "Запис кешу",
  "tokenUsage.tokens.total": "Разом",
  "tokenUsage.cost": "Витрати за сьогодні",
