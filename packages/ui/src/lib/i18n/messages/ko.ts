...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': '로컬 스크립트',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': '셸 명령을 로컬에서 실행합니다. 세션 생성 없음, 모델 토큰 없음',
  'sessions.scheduledTasks.dialog.lastOutput.label': '마지막 출력',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': '실행 방식',
  'sessions.scheduledTasks.editor.executionKind.ai': 'AI 세션',
  'sessions.scheduledTasks.editor.executionKind.script': '로컬 스크립트',
  'sessions.scheduledTasks.editor.executionKind.aiHint': '새 AI 세션을 만들고 프롬프트를 모델에 보냅니다.',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': '이 머신에서 셸 명령을 직접 실행합니다. 세션 없음, 토큰 소모 없음.',
  'sessions.scheduledTasks.editor.command.label': '명령',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': '명령은 필수입니다',
  ...
  'chat.toolName.read': '파일 읽기',
  'chat.toolName.write': '파일 쓰기',
  'chat.toolName.edit': '파일 편집',
  'chat.toolName.multiedit': '다중 편집',
  'chat.toolName.applyPatch': '패치 적용',
  'chat.toolName.bash': '셸 명령',
  'chat.toolName.grep': '파일 검색',
  'chat.toolName.glob': '파일 찾기',
  'chat.toolName.list': '디렉터리 나열',
  'chat.toolName.task': '에이전트 작업',
  'chat.toolName.webfetch': 'URL 가져오기',
  'chat.toolName.websearch': '웹 검색',
  'chat.toolName.codesearch': '코드 검색',
  'chat.toolName.todowrite': '할 일 업데이트',
  'chat.toolName.todoread': '할 일 읽기',
  'chat.toolName.skill': '스킬 로드',
  'chat.toolName.question': '질문',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber(웹)',
  'chat.toolName.openchamberMemory': 'OpenChamber(메모리)',
  'chat.toolName.planEnter': '계획 모드',
  'chat.toolName.planExit': '빌드 모드',
  'chat.toolName.structuredOutput': '구조화된 출력',
  'chat.toolName.pigeonMemory': 'Pigeon 메모리',
  'chat.toolName.pigeonProfile': 'Pigeon 프로필',
  'chat.toolName.pigeonConfig': 'Pigeon 설정',
  'chat.workStatus.section.memoryTools': '개인 메모리',
  'chat.workStatus.memory.written': '{count}개 저장됨',
  'chat.workStatus.memory.readCount': '{count}개 불러옴',
  'chat.workStatus.memory.actionWrite': '쓰기',
  'chat.workStatus.memory.actionRead': '불러오기',
  'chat.workStatus.memory.unnamed': '(제목 없음)',
  'chat.toolPart.filesCount': '{count}개 파일',
  'chat.toolPart.questionsAsked': '{count}개 질문',
  'chat.toolPart.moreHidden': '+{count}개 더…',
  'chat.toolPart.subagentWaiting': '하위 에이전트 활동 대기 중...',
  'chat.toolPart.subagentNoSession': '작업 메타데이터에 하위 에이전트 세션 ID가 없습니다.',
  'chat.toolPart.todoTasks': '{count}개 작업',
  'chat.todo.total': '전체',
  ...
  'tokenUsage.button.aria': '토큰 사용 통계',
  'tokenUsage.button.title': '오늘의 토큰 — 세부 정보 열기',
  'tokenUsage.dialog.title': '토큰 사용량',
  'tokenUsage.range.today': '오늘',
  'tokenUsage.range.7days': '7일',
  'tokenUsage.range.30days': '30일',
  'tokenUsage.tab.daily': '일별',
  'tokenUsage.tab.models': '모델별',
  'tokenUsage.tokens.input': '입력',
  'tokenUsage.tokens.output': '출력',
  'tokenUsage.tokens.reasoning': '추론',
  'tokenUsage.tokens.cacheRead': '캐시 읽기',
  'tokenUsage.tokens.cacheWrite': '캐시 쓰기',
  "tokenUsage.tokens.total": "합계",
  'tokenUsage.cost': '오늘 비용',
  'tokenUsage.model': '모델',
