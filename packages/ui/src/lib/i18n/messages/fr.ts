...
export const dict = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': 'Exécute une commande shell localement – aucune session, aucun jeton de modèle',
  'sessions.scheduledTasks.dialog.lastOutput.label': 'Dernière sortie',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': 'Exécution',
  'sessions.scheduledTasks.editor.executionKind.ai': 'Session IA',
  'sessions.scheduledTasks.editor.executionKind.script': 'Script local',
  'sessions.scheduledTasks.editor.executionKind.aiHint': 'Crée une nouvelle session IA et envoie le prompt à un modèle.',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': 'Exécute une commande shell directement sur cette machine – aucune session, zéro jeton de modèle.',
  'sessions.scheduledTasks.editor.command.label': 'Commande',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': 'La commande est requise',
  ...
  'chat.toolName.read': 'Lire le fichier',
  'chat.toolName.write': 'Écrire le fichier',
  'chat.toolName.edit': 'Modifier le fichier',
  'chat.toolName.multiedit': 'Modification multiple',
  'chat.toolName.applyPatch': 'Appliquer le patch',
  'chat.toolName.bash': 'Commande shell',
  'chat.toolName.grep': 'Rechercher dans les fichiers',
  'chat.toolName.glob': 'Rechercher des fichiers',
  'chat.toolName.list': 'Lister le répertoire',
  'chat.toolName.task': 'Tâche d\'agent',
  'chat.toolName.webfetch': 'Récupérer l\'URL',
  'chat.toolName.websearch': 'Recherche web',
  'chat.toolName.codesearch': 'Recherche de code',
  'chat.toolName.todowrite': 'Mettre à jour la liste des tâches',
  'chat.toolName.todoread': 'Lire la liste des tâches',
  'chat.toolName.skill': 'Charger la compétence',
  'chat.toolName.question': 'Question',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber (Web)',
  'chat.toolName.openchamberMemory': 'OpenChamber (Mémoire)',
  'chat.toolName.planEnter': 'Mode plan',
  'chat.toolName.planExit': 'Mode build',
  'chat.toolName.structuredOutput': 'Sortie structurée',
  'chat.toolName.pigeonMemory': 'Mémoire Pigeon',
  'chat.toolName.pigeonProfile': 'Profil Pigeon',
  'chat.toolName.pigeonConfig': 'Configuration Pigeon',
  'chat.workStatus.section.memoryTools': 'Mémoire personnelle',
  'chat.workStatus.memory.written': '{count} écrites',
  'chat.workStatus.memory.readCount': '{count} rappelées',
  'chat.workStatus.memory.actionWrite': 'Écrire',
  'chat.workStatus.memory.actionRead': 'Rappeler',
  'chat.workStatus.memory.unnamed': '(sans titre)',
  'chat.toolPart.filesCount': '{count} fichiers',
  'chat.toolPart.questionsAsked': '{count} question(s) posée(s)',
  'chat.toolPart.moreHidden': '+{count} de plus…',
  'chat.toolPart.subagentWaiting': 'En attente de l\'activité du sous-agent...',
  'chat.toolPart.subagentNoSession': 'Aucun ID de session de sous-agent dans les métadonnées de la tâche.',
  'chat.toolPart.todoTasks': '{count} tâches',
  ...
  'tokenUsage.button.aria': 'Statistiques de consommation de jetons',
  'tokenUsage.button.title': 'Jetons du jour — ouvrir les détails',
  'tokenUsage.dialog.title': 'Consommation de jetons',
  'tokenUsage.range.today': 'Aujourd\'hui',
  'tokenUsage.range.7days': '7 jours',
  'tokenUsage.range.30days': '30 jours',
  'tokenUsage.tab.daily': 'Par jour',
  'tokenUsage.tab.models': 'Par modèle',
  'tokenUsage.tokens.input': 'Entrée',
  'tokenUsage.tokens.output': 'Sortie',
  'tokenUsage.tokens.reasoning': 'Raisonnement',
  'tokenUsage.tokens.cacheRead': 'Lecture du cache',
  'tokenUsage.tokens.cacheWrite': 'Écriture du cache',
  "tokenUsage.tokens.total": "Total",
  'tokenUsage.cost': 'Coût du jour',
