...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.scheduledTasks.dialog.executionKind.script": "Script local",
  "sessions.scheduledTasks.dialog.executionKind.scriptHint": "Executa um comando shell localmente — sem sessão e sem tokens de modelo",
  "sessions.scheduledTasks.dialog.lastOutput.label": "Última saída",
  ...
  "sessions.scheduledTasks.editor.executionKind.label": "Execução",
  "sessions.scheduledTasks.editor.executionKind.ai": "Sessão de IA",
  "sessions.scheduledTasks.editor.executionKind.script": "Script local",
  "sessions.scheduledTasks.editor.executionKind.aiHint": "Cria uma nova sessão de IA e envia o prompt ao modelo.",
  "sessions.scheduledTasks.editor.executionKind.scriptHint": "Executa um comando shell diretamente nesta máquina — sem sessão, zero tokens de modelo.",
  "sessions.scheduledTasks.editor.command.label": "Comando",
  "sessions.scheduledTasks.editor.command.placeholder": "curl -fsS http://127.0.0.1:3001/health",
  "sessions.scheduledTasks.editor.validation.commandRequired": "O comando é obrigatório",
  ...
  "contextSidebar.rate.title": "Model Output Rate",
  "contextSidebar.rate.streaming": "streaming",
  "contextSidebar.rate.completed": "completed",
  "contextSidebar.rate.precise": "precise",
  "contextSidebar.rate.estimating": "estimating",
  "contextSidebar.rate.estimatingHint": "Tokenizer loading or unavailable - showing chars/4 estimate",
  "contextSidebar.rate.instant": "Instant",
  "contextSidebar.rate.lastAvg": "Last turn",
  "contextSidebar.rate.avg": "Avg",
  "contextSidebar.rate.peak": "Peak",
  "contextSidebar.rate.elapsed": "Elapsed",
  "contextSidebar.rate.totalTokens": "{count} tokens",
  "contextSidebar.rate.historyAvg": "History avg",
  "contextSidebar.rate.tokenizerFailed": "Tokenizer failed to load - using estimate",
  "contextSidebar.rate.empty": "Start a turn to see output rate - live tok/s and history avg will appear here.",
  "contextSidebar.rate.model": "Model",
  ...
  "chat.toolName.read": "Ler arquivo",
  "chat.toolName.write": "Escrever arquivo",
  "chat.toolName.edit": "Editar arquivo",
  "chat.toolName.multiedit": "Multi-editar",
  "chat.toolName.applyPatch": "Aplicar patch",
  "chat.toolName.bash": "Comando shell",
  "chat.toolName.grep": "Pesquisar em arquivos",
  "chat.toolName.glob": "Localizar arquivos",
  "chat.toolName.list": "Listar diretório",
  "chat.toolName.task": "Tarefa do agente",
  "chat.toolName.webfetch": "Buscar URL",
  "chat.toolName.websearch": "Pesquisa na web",
  "chat.toolName.codesearch": "Pesquisa de código",
  "chat.toolName.todowrite": "Atualizar lista de tarefas",
  "chat.toolName.todoread": "Ler lista de tarefas",
  "chat.toolName.skill": "Carregar habilidade",
  "chat.toolName.question": "Pergunta",
  "chat.toolName.lsp": "LSP",
  "chat.toolName.openchamberWeb": "OpenChamber (Web)",
  "chat.toolName.openchamberMemory": "OpenChamber (Memória)",
  "chat.toolName.planEnter": "Modo plano",
  "chat.toolName.planExit": "Modo build",
  "chat.toolName.structuredOutput": "Saída estruturada",
  "chat.toolName.pigeonMemory": "Memória do Pigeon",
  "chat.toolName.pigeonProfile": "Perfil do Pigeon",
  "chat.toolName.pigeonConfig": "Configuração do Pigeon",
  "chat.workStatus.section.memoryTools": "Memória pessoal",
  "chat.workStatus.memory.written": "{count} gravadas",
  "chat.workStatus.memory.readCount": "{count} recuperadas",
  "chat.workStatus.memory.actionWrite": "Gravar",
  "chat.workStatus.memory.actionRead": "Recuperar",
  "chat.workStatus.memory.unnamed": "(sem título)",
  "chat.toolPart.filesCount": "{count} arquivos",
  "chat.toolPart.questionsAsked": "{count} pergunta(s) feita(s)",
  "chat.toolPart.moreHidden": "+{count} mais…",
  "chat.toolPart.subagentWaiting": "Aguardando atividade do subagente...",
  "chat.toolPart.subagentNoSession": "Nenhum ID de sessão de subagente nos metadados da tarefa.",
  "chat.toolPart.todoTasks": "{count} tarefas",
  ...
  "tokenUsage.button.aria": "Estatísticas de consumo de tokens",
  "tokenUsage.button.title": "Tokens hoje — abrir detalhes",
  "tokenUsage.dialog.title": "Consumo de tokens",
  "tokenUsage.range.today": "Hoje",
  "tokenUsage.range.7days": "7 dias",
  "tokenUsage.range.30days": "30 dias",
  "tokenUsage.tab.daily": "Por dia",
  "tokenUsage.tab.models": "Por modelo",
  "tokenUsage.tokens.input": "Entrada",
  "tokenUsage.tokens.output": "Saída",
  "tokenUsage.tokens.reasoning": "Raciocínio",
  "tokenUsage.tokens.cacheRead": "Leitura de cache",
  "tokenUsage.tokens.cacheWrite": "Escrita de cache",
  "tokenUsage.tokens.total": "Total",
  "tokenUsage.cost": "Custo hoje",
  "tokenUsage.model": "Modelo",
  "tokenUsage.empty": "Sem consumo de tokens neste período",
  "tokenUsage.error": "Falha ao carregar estatísticas de tokens",
  "tokenUsage.retry": "Tentar novamente",
