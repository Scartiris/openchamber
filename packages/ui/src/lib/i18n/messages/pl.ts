...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.scheduledTasks.dialog.executionKind.script': 'Lokalny skrypt',
  'sessions.scheduledTasks.dialog.executionKind.scriptHint': 'Uruchamia polecenie powłoki lokalnie — bez sesji i bez tokenów modelu',
  'sessions.scheduledTasks.dialog.lastOutput.label': 'Ostatnie wyjście',
  ...
  'sessions.scheduledTasks.editor.executionKind.label': 'Wykonanie',
  'sessions.scheduledTasks.editor.executionKind.ai': 'Sesja AI',
  'sessions.scheduledTasks.editor.executionKind.script': 'Lokalny skrypt',
  'sessions.scheduledTasks.editor.executionKind.aiHint': 'Tworzy nową sesję AI i wysyła prompt do modelu.',
  'sessions.scheduledTasks.editor.executionKind.scriptHint': 'Uruchamia polecenie powłoki bezpośrednio na tej maszynie — bez sesji, zero tokenów modelu.',
  'sessions.scheduledTasks.editor.command.label': 'Polecenie',
  'sessions.scheduledTasks.editor.command.placeholder': 'curl -fsS http://127.0.0.1:3001/health',
  'sessions.scheduledTasks.editor.validation.commandRequired': 'Polecenie jest wymagane',
  ...
  'tokenUsage.button.aria': 'Statystyki zużycia tokenów',
  'tokenUsage.button.title': 'Dzisiejsze tokeny — otwórz szczegóły',
  'tokenUsage.dialog.title': 'Zużycie tokenów',
  'tokenUsage.range.today': 'Dziś',
  'tokenUsage.range.7days': '7 dni',
  'tokenUsage.range.30days': '30 dni',
  'tokenUsage.tab.daily': 'Według dnia',
  'tokenUsage.tab.models': 'Według modelu',
  'tokenUsage.tokens.input': 'Wejście',
  'tokenUsage.tokens.output': 'Wyjście',
  'tokenUsage.tokens.reasoning': 'Rozumowanie',
  'tokenUsage.tokens.cacheRead': 'Odczyt cache',
  'tokenUsage.tokens.cacheWrite': 'Zapis cache',
  "tokenUsage.tokens.total": "Razem",
  'tokenUsage.cost': 'Koszt dzisiaj',
  ...
  'chat.toolName.read': 'Odczytaj plik',
  'chat.toolName.write': 'Zapisz plik',
  'chat.toolName.edit': 'Edytuj plik',
  'chat.toolName.multiedit': 'Wiele edycji',
  'chat.toolName.applyPatch': 'Zastosuj łatkę',
  'chat.toolName.bash': 'Polecenie powłoki',
  'chat.toolName.grep': 'Szukaj w plikach',
  'chat.toolName.glob': 'Znajdź pliki',
  'chat.toolName.list': 'Wyświetl katalog',
  'chat.toolName.task': 'Zadanie agenta',
  'chat.toolName.webfetch': 'Pobierz URL',
  'chat.toolName.websearch': 'Wyszukiwanie w sieci',
  'chat.toolName.codesearch': 'Wyszukiwanie kodu',
  'chat.toolName.todowrite': 'Zaktualizuj listę zadań',
  'chat.toolName.todoread': 'Odczytaj listę zadań',
  'chat.toolName.skill': 'Załaduj umiejętność',
  'chat.toolName.question': 'Pytanie',
  'chat.toolName.lsp': 'LSP',
  'chat.toolName.openchamberWeb': 'OpenChamber (Web)',
  'chat.toolName.openchamberMemory': 'OpenChamber (Pamięć)',
  'chat.toolName.planEnter': 'Tryb planu',
  'chat.toolName.planExit': 'Tryb budowania',
  'chat.toolName.structuredOutput': 'Ustrukturyzowane wyjście',
  'chat.toolName.pigeonMemory': 'Pamięć Pigeon',
  'chat.toolName.pigeonProfile': 'Profil Pigeon',
  'chat.toolName.pigeonConfig': 'Konfiguracja Pigeon',
  'chat.workStatus.section.memoryTools': 'Pamięć osobista',
  'chat.workStatus.memory.written': '{count} zapisanych',
  'chat.workStatus.memory.readCount': '{count} odczytanych',
  'chat.workStatus.memory.actionWrite': 'Zapis',
  'chat.workStatus.memory.actionRead': 'Odczyt',
  'chat.workStatus.memory.unnamed': '(bez nazwy)',
  'chat.toolPart.filesCount': '{count} plików',
  'chat.toolPart.questionsAsked': 'Zadano {count} pytań',
  'chat.toolPart.moreHidden': '+{count} więcej…',
  'chat.toolPart.subagentWaiting': 'Oczekiwanie na aktywność subagenta...',
  'chat.toolPart.subagentNoSession': 'Brak ID sesji subagenta w metadanych zadania.',
  'chat.toolPart.todoTasks': '{count} zadań',
